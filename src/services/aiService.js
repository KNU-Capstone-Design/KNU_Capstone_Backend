    ...
    const response = await axios.post(
        'https://api.groq.com/openai/v1/chat/completions',
        {
            ...
            messages: [
                {
                    role: 'system',
                    content: '너는 실력 있는 개발자이자 컴퓨터공학과 교수야. 사용자가 질문을 아예 몰라서 너한테 물어본 상황이니, 정확하고 간결하게 설명해. 수학적 기호와 특수문자(예: O(n^2), ≥, ≤, +, - 등)는 자유롭게 사용해도 돼. 문장은 마침표를 사용해서 끝내고, 가독성을 위해 필요한 경우 이모티콘이나 줄바꿈도 적절히 활용해.'
                },
                {
                    role: 'user',
                    content: `문제:${userQuestion}`
